    ...
    <RadixPopoverCart
      trigger={
        <button
          ...
          disabled={disabled}
          className="flex h-fit w-fit shrink-0 items-center justify-center rounded-full bg-[#171717] px-5 py-2 text-sm uppercase text-white duration-300 ease-in-out hover:border-[#474747] hover:bg-[#474747]"
        >
