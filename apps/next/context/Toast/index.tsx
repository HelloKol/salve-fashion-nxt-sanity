...
export const ToastProvider: React.FC<ToastsProps> = ({ children, ...props }) => {
  ...
  return (
    ...
    >
      <ToastContextList.Provider
        value={React.useMemo(() => ({ toastElementsMapRef, handleRemoveToast }), [handleRemoveToast])}
      >
...
const ToastItem: React.FC<ToastProps> = ({ toast, id, onOpenChange, onClose }) => {
